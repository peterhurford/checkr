...
#TODO: Quickcheck with the test_objects, use preconditions to screen objects and then test postconditions hold.
#TODO: Quickcheck runs in test suite.
#TODO: Quickcheck with specified postconditions.
